...
namespace TirelireProject.Controllers
{
    public class RolesController : Controller
    {
        ...
        public RolesController(TirelireProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Role != null ? 
                          ...
                          Problem("Entity set 'TirelireProjectContext.Role'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TirelireProjectContext.Role'  is null.");
            }
            var role = await _context.Role.FindAsync(id);
            if (role != null)
            {
